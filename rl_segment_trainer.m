...
for seg_num = 1:length(valid_segs)
    ...
    while consec_fail < MAX_CONSEC_FAIL
        ...
        % ── Disable visualiser for training (prevents 600s freeze) ──────
        ...
        for ep = 1:N_EPISODES_PER_LEVEL
            ...
            % Tell sector_switch to ONLY activate this segment
        ...
        % Restore visualiser after level
        if ~isempty(vis_block)
    ...
    % Reset training mode so normal simulation works after training
